...
def main():
    ...
    if args.vil:
        feature_type.append("vil")
    if args.video:
        feature_type.append("video")
    ...
    for each_feature_type in feature_type:
        ...
        for topk in topk_list:
            ...
            results[each_feature_type]["top{}".format(topk_temp)]={
                ...
                "mHitRate": mHitRate,
                "Prec": mP,
                "average": (mAP + mHitRate + mP) / 3
            }

    write_json("{}/metric_results_backup.json".format(args.output_metric_dir),results)
